...
export default async function HomePage() {
  ...
  const demoProperty = data.items.find((x)=>x.has_3d) ?? data.items[0];
  return <>
    ...
    <section className="section"><div className="container stack" style={{gap:28}}>
      <div className="row" style={{justifyContent:"space-between",alignItems:"end"}}><div className="stack" style={{gap:8}}><span className="eyebrow">Gợi ý hôm nay</span><h2>Nhà nổi bật</h2></div><Link className="btn btn-secondary" href="/properties">Xem tất cả</Link></div>
